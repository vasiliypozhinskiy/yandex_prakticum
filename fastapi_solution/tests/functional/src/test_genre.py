...
from fastapi_solution.tests.functional.testdata.movies_data.get_data_genre import genre_data
from fastapi_solution.tests.functional.utils.hash_creater_for_redis import create_hash_key
