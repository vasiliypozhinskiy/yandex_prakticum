...
from app.utils.exceptions import NotFoundError, BadIdFormat
...
@role_blueprint.route('/role/<string:role_title>', endpoint='delete_update_role', methods=['PATCH', 'DELETE'])
@swag_from(f'{SWAGGER_DOCS_RELATIVE_PATH}/role/create_role.yaml', endpoint='role.create_role')
@swag_from(f'{SWAGGER_DOCS_RELATIVE_PATH}/role/delete_role.yaml', endpoint='role.delete_update_role', methods=['DELETE'])
@swag_from(f'{SWAGGER_DOCS_RELATIVE_PATH}/role/get_list_role.yaml', endpoint='role.list_role', methods=['GET'])
@swag_from(f'{SWAGGER_DOCS_RELATIVE_PATH}/role/update_role.yaml', endpoint='role.delete_update_role',methods=['PATCH'])
