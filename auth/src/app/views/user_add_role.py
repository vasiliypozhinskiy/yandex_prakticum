...
@add_role_blueprint.route('/user_add_role/<string:user_id>/<string:role_title>', endpoint='add_role', methods=['POST', 'DELETE'])
@swag_from(f'{SWAGGER_DOCS_RELATIVE_PATH}/role/add_role_for_user.yaml', endpoint='role_add_user.add_role')
@swag_from(f'{SWAGGER_DOCS_RELATIVE_PATH}/role/remove_role_for_user.yaml', endpoint='role_add_user.add_role')
